        ...
        <div class="w-3/4 mx-auto">
            ...
            <form action="{{ url('surat') }}" method="post">
                ...
                <div class="py-1">
                    ...
                    <textarea
                        class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"
                        name="isi" id="isi" cols="30" rows="10" placeholder="Masukkan Isi"></textarea>
                </div>
                <div class="grid grid-cols-3 gap-4 my-2">
                    <div>
                        <label
                            class="dark:text-white block pb-1 pl-4 after:content-['*'] after:ml-0.5 after:text-red-500"
                            for="kategori">Kategori</label>
                        <input
                            class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"
                            type="text" name="kategori" id="kategori" placeholder="Masukkan Kategori">
                    </div>
                    <div>
                        <label
                            class="dark:text-white block pb-1 pl-4 after:content-['*'] after:ml-0.5 after:text-red-500"
                    ...
                    <div>
                        ...
                        <input
                            class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"
                            type="text" name="penerima" id="penerima" placeholder="Masukkan Penerima">
                    </div>
                </div>
